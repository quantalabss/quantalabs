...
export const metadata: Metadata = {
  title:
    "Validator & RPC Node Infrastructure | Enterprise Bare-Metal | Quantalabs",
  description:
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter text-black mb-6 leading-[1.0]">
                <span className="text-[#C4ED5F]">Institutional</span>
                <br />
                <span className="text-gray-300">Validator Nodes.</span>
              </h1>
              <p className="text-xl text-gray-500 font-medium leading-relaxed mb-10 max-w-xl">
                Enterprise-grade bare-metal validator clusters and globally
                distributed RPC infrastructure for Quantachain. Built for
                institutions that cannot afford downtime.
              </p>
            ...
            <div className="relative border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-gray-950 aspect-square md:aspect-[4/3] lg:aspect-square animate-fade-in">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex gap-3">
                <div className="flex-1 bg-black/70 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                  ...
                  <p className="text-[#C4ED5F] font-extrabold text-2xl">
                    99.99%
                  </p>
                </div>
                <div className="flex-1 bg-black/70 backdrop-blur-md border border-white/10 rounded-2xl p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {slaMetrics.map((s, i) => (
              <div key={i} className="text-center">
                ...
                <p
                  className={`text-2xl font-extrabold ${s.green ? "text-[#C4ED5F]" : "text-white"}`}
                >
                  {s.value}
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-extrabold text-black tracking-tight">
              Enterprise-grade from hardware up.
            </h2>
          </div>
      ...
      <section className="py-20 bg-gray-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-8">
              ...
              <div className="space-y-3">
                {[
                  {
                    name: "validator-01.fra.quantalabs.cc",
                    region: "Frankfurt",
                    status: "ACTIVE",
                    latency: "8ms",
                  },
                  {
                    name: "validator-02.nyc.quantalabs.cc",
                    region: "New York",
                    status: "ACTIVE",
                    latency: "11ms",
                  },
                  {
                    name: "validator-03.sgp.quantalabs.cc",
                    region: "Singapore",
                    status: "ACTIVE",
                    latency: "14ms",
                  },
                      ...
                      <span
                        className={`text-[10px] font-black px-2.5 py-1 rounded-full ${
                          node.status === "ACTIVE" || node.status === "SERVING"
                            ...
                            : "bg-gray-100 text-gray-500 border-2 border-black"
                        }`}
                      >
                        {node.status}
                      </span>
