        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-gray-50 rounded-3xl p-8 lg:p-12 border border-gray-100">
            <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <FileText className="text-[#00E599] w-6 h-6" />
              Assessment Template
            </h3>
            ...
            <a 
              ...
              download
              className="group flex items-center justify-center space-x-3 px-8 py-4 bg-black text-white rounded-full font-bold hover:bg-[#00E599] hover:text-black transition-all shadow-lg hover:scale-105 active:scale-95 w-full sm:w-auto"
            >
          ...
          <div>
            ...
            <div className="space-y-6">
              {steps.map((step, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#00E599]/10 text-[#00E599] flex items-center justify-center font-bold">
                    {i + 1}
                  </div>
                  <div>
            ...
            <div className="mt-12 p-6 bg-black text-white rounded-2xl">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 text-[#00E599] font-bold hover:text-white transition-colors">
