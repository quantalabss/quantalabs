...
import { ArrowUpRight, Lock, Code2, Server } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-8 p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50/50">
              ...
              <h1 className="text-[3rem] md:text-[5rem] font-black tracking-tighter leading-[0.95] text-black">
                <span className="text-[#C4ED5F]">Quanta</span><span className="relative inline-block mt-1">Cipher.<span className="absolute bottom-1 left-0 w-full h-[6px] bg-[#C4ED5F] -z-10"></span></span>
              </h1>
            </div>
        ...
        <div className="border border-gray-200 shadow-sm bg-white overflow-hidden mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            <div className="p-8">
              <Lock className="w-6 h-6 mb-4 text-black" />
              <h3 className="font-bold text-lg mb-2">Quantum-Resistant</h3>
              <p className="text-sm text-gray-600">Uses FIPS-standardized Kyber key encapsulation mechanisms.</p>
            </div>
            <div className="p-8">
              <Server className="w-6 h-6 mb-4 text-black" />
              <h3 className="font-bold text-lg mb-2">Zero-Trust</h3>
              <p className="text-sm text-gray-600">Keys are generated and retained client-side; only encrypted payloads touch the network.</p>
            </div>
            <div className="p-8">
              <Code2 className="w-6 h-6 mb-4 text-black" />
              <h3 className="font-bold text-lg mb-2">Cross-Platform</h3>
              <p className="text-sm text-gray-600">Compile once in Rust, use flawlessly in JS/TS and Python.</p>
            </div>
          </div>
        </div>

        {/* Code Example */}
        <div className="border border-gray-200 shadow-sm bg-gray-900 text-white overflow-hidden">
          ...
          <div className="p-8 font-mono text-sm leading-relaxed overflow-x-auto text-gray-300">
            <pre><code>{`import { QuantaCipher } from 'quantacipher-sdk';
...
const plaintext = sdk.decryptSecure(ciphertext, keys.privateKey);`}</code></pre>
          </div>
          <div className="p-8 border-t border-gray-800 bg-black flex justify-between items-center">
            <span className="text-sm text-gray-400 font-medium">Also available for Python via pip install quantacipher</span>
            <a href="https://quantacipher.com" target="_blank" rel="noopener noreferrer" className="px-6 py-2 bg-[#C4ED5F] text-black font-bold text-xs uppercase tracking-widest hover:bg-white transition-colors">
