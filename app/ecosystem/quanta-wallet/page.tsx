...
import { ArrowUpRight, Wallet, ShieldCheck, HardDrive } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-8 p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50/50">
              ...
              <h1 className="text-[3rem] md:text-[5rem] font-black tracking-tighter leading-[0.95] text-black">
                <span className="text-[#C4ED5F]">Quanta</span> <span className="relative inline-block mt-1">Wallet.<span className="absolute bottom-1 left-0 w-full h-[6px] bg-[#C4ED5F] -z-10"></span></span>
              </h1>
            </div>
        ...
        <div className="border border-gray-200 shadow-sm bg-white overflow-hidden mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            <div className="p-8">
              <ShieldCheck className="w-6 h-6 mb-4 text-[#C4ED5F]" />
              <h3 className="font-bold text-lg mb-2">Falcon-512 Native</h3>
              <p className="text-sm text-gray-600">No classical elliptic-curve cryptography is used anywhere in the signing path. PQC Level 5 compliance.</p>
            </div>
            <div className="p-8">
              <HardDrive className="w-6 h-6 mb-4 text-black" />
              <h3 className="font-bold text-lg mb-2">Deterministic HD Derivation</h3>
              <p className="text-sm text-gray-600">BIP-39 24-word mnemonic with deterministic Falcon-512 key derivation and AES-GCM local storage.</p>
            </div>
            <div className="p-8">
              <Wallet className="w-6 h-6 mb-4 text-black" />
              <h3 className="font-bold text-lg mb-2">dApp RPC API</h3>
              <p className="text-sm text-gray-600">Interact with dApps via window.quanta to connect, sign transactions, and authorize messages securely.</p>
            </div>
          </div>
        </div>

        {/* Technical Callout */}
        <div className="border border-gray-200 shadow-sm bg-gray-50 flex flex-col md:flex-row items-center justify-between p-10">
          ...
          <a href="#" className="px-8 py-4 bg-black text-white font-bold text-xs uppercase tracking-widest hover:bg-[#C4ED5F] hover:text-black transition-colors flex items-center gap-2 whitespace-nowrap">
