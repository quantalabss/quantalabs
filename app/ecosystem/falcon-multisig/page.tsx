  ...
  return (
    <div className="bg-white min-h-screen pt-28 pb-24 text-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-8 p-10 md:p-16 border-b-2 lg:border-b-0 lg:border-r-2 border-black bg-gray-50/50">
              ...
              <h1 className="text-[3rem] md:text-[5rem] font-black tracking-tighter leading-[0.95] text-black">
                <span className="text-[#C4ED5F]">Falcon-</span>
            ...
            <div className="lg:col-span-4 p-10 flex flex-col justify-end bg-black text-white relative overflow-hidden">
              ...
              <p className="text-sm text-gray-300 font-medium relative z-10">
                A production-grade post-quantum threshold multisignature library
                using Falcon-512 (NIST FIPS 206 / FN-DSA). Extracted directly
                from QuantaChain&apos;s consensus layer.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            <div className="p-8">
              ...
              <p className="text-sm text-gray-600">
                No dependency on any blockchain runtime, EVM, or specific
                transaction format. Integrate it into any protocol requiring
            ...
            <div className="p-8">
              ...
              <p className="text-sm text-gray-600">
                Uses{" "}
                <code className="text-xs font-mono bg-gray-100 p-1">
                  falcon-rust
                </code>{" "}
                (pure Rust, no C FFI). Runs perfectly in browsers and
            ...
            <div className="p-8">
              ...
              <p className="text-sm text-gray-600">
                Domain separation applied to all signed data internally. All
                secret keys are forcefully zeroized on drop via the zeroize
                crate.
              </p>
            </div>
          </div>
        ...
        <div className="border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-black p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="font-mono text-sm text-[#C4ED5F] bg-black px-6 py-4 border border-gray-800 w-full sm:w-auto">
            cargo add falcon-multisig
          </div>
          <div className="flex gap-4 w-full sm:w-auto">
            <a
              href="https://crates.io/crates/falcon-multisig"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-white border-2 border-transparent text-black font-bold text-xs uppercase tracking-widest hover:bg-[#C4ED5F] hover:border-black transition-all shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] md:shadow-none w-full text-center"
            >
              View on Crates.io
            </a>
          </div>
