      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12 text-black/80 font-medium leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                To provide and manage your access to our services and APIs.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              <br />
              <br />
              <strong>Email:</strong> privacy@quantalabs.cc
              <br />
              <strong>Address:</strong> QuantaLabs Private Limited, Coimbatore,
              Tamil Nadu, India
            </p>
          </section>
        </div>
