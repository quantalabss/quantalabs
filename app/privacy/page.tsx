      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12 text-gray-600 font-normal leading-relaxed text-sm md:text-base">
          <section>
            ...
            <p className="mb-4">
              QuantaLabs Private Limited (&quot;QuantaLabs&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;)
              respects your privacy and is committed to protecting your personal
              data. This Privacy Policy explains how we collect, use, disclose,
              and safeguard your information when you visit our website
              (quantalabs.cc), use our post-quantum cryptography APIs, or engage
              with our enterprise services.
            </p>
            <p>
              As a cryptography engineering company, we believe in data
              minimization. We only collect the data necessary to provide our
              services and secure our infrastructure.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li>
                <strong className="text-gray-800 font-medium">Identity and Contact Data:</strong> Name, email address,
                company name, and job title when you book a consultation or
                contact us.
              </li>
              <li>
                <strong className="text-gray-800 font-medium">Technical Data:</strong> IP addresses, browser type,
                time zone setting, and operating system when you interact with
                our website.
              </li>
              <li>
                <strong className="text-gray-800 font-medium">Usage Data:</strong> Information about how you use our
                APIs, website, and services. We do not inspect the contents of
                encrypted payloads passing through our infrastructure.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              While we engineer solutions designed to protect data against
              Cryptographically Relevant Quantum Computers (CRQCs), please note
              that standard website communications may utilize classical
              cryptography (such as TLS 1.3) unless otherwise specified. For
              secure transmission of vulnerability reports, please utilize our
              provided PGP key on the Contact page.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <br />
              <br />
              <strong className="text-gray-800 font-medium">Email:</strong> privacy@quantalabs.cc
              <br />
              <strong className="text-gray-800 font-medium">Address:</strong> QuantaLabs Private Limited, Coimbatore,
              Tamil Nadu, India
            </p>
          </section>
        </div>
