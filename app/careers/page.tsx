...
export const metadata: Metadata = {
  ...
  description: "Join the protocol engineering team securing the post-quantum future.",
};
  ...
  return (
    <div className="bg-white min-h-screen pt-28 pb-24 text-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* How to Apply notice */}
        <div className="border border-[#C4ED5F] bg-[#C4ED5F]/10 px-8 py-5 mb-8 flex items-start gap-4">
          <Mail className="w-5 h-5 text-black shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-bold text-black mb-1">To apply for any position, email your resume & cover letter to:</p>
            <a href="mailto:hr@quantalabs.cc" className="font-mono text-sm font-bold text-black underline underline-offset-2 hover:no-underline">hr@quantalabs.cc</a>
            <p className="text-xs text-black/60 mt-1 font-medium">Include the role title and REQ number in the subject line.</p>
          </div>
        </div>
        ...
        <div className="border border-gray-200 shadow-sm bg-white overflow-hidden">
          ...
          <div className="bg-gray-100 border-b border-gray-200 px-8 py-4 hidden md:grid grid-cols-12 gap-4">
            <div className="col-span-5 font-mono text-[10px] font-bold text-gray-500 uppercase tracking-widest">Role</div>
            <div className="col-span-3 font-mono text-[10px] font-bold text-gray-500 uppercase tracking-widest">Department</div>
            <div className="col-span-3 font-mono text-[10px] font-bold text-gray-500 uppercase tracking-widest">Location</div>
            ...
            {OPEN_POSITIONS.map((job, index) => (
              <a
                ...
                className={`group px-8 py-6 md:py-8 flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center hover:bg-gray-50 transition-colors ${
                  index !== OPEN_POSITIONS.length - 1 ? 'border-b border-gray-200' : ''
                }`}
              >
                ...
                <div className="md:col-span-3 mb-2 md:mb-0">
                  <span className="font-mono text-xs font-bold text-gray-500 md:hidden mr-2">DEPT:</span>
                  <span className="text-sm font-bold text-black">{job.department}</span>
                </div>
                
                <div className="md:col-span-3 mb-4 md:mb-0">
                  <span className="font-mono text-xs font-bold text-gray-500 md:hidden mr-2">LOC:</span>
                  <span className="text-sm font-medium text-gray-600">{job.location}</span>
                </div>
                
                <div className="md:col-span-1 flex justify-end">
                  <div className="w-10 h-10 border border-gray-200 bg-white flex items-center justify-center group-hover:bg-black group-hover:border-black transition-colors">
          ...
          <div className="bg-gray-50 border-t border-gray-200 px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="font-bold text-black mb-1">Don&apos;t see a fit?</h3>
              <p className="text-sm text-gray-600">Send your resume anyway. We&apos;re always looking for exceptional talent.</p>
            </div>
            <a 
              href="mailto:hr@quantalabs.cc?subject=Open Application – QuantaLabs"
              className="px-6 py-3 bg-[#C4ED5F] text-black font-bold text-xs uppercase tracking-widest hover:bg-black hover:text-white transition-all whitespace-nowrap shadow-sm"
            >
              Submit Resume
            </a>
          </div>
