...
import { ArrowUpRight, SearchCheck, CheckCircle2, AlertTriangle, FileText } from "lucide-react";

export const metadata: Metadata = {
  title: "CBOM Audit | QuantaLabs",
  description: "Cryptographic Bill of Materials readiness assessment for FIPS 203 compliance.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-8 p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50/50">
              ...
              <h1 className="text-[3rem] md:text-[5rem] font-black tracking-tighter leading-[0.95] text-black">
                <span className="text-[#C4ED5F]">CBOM</span> <span className="relative inline-block mt-1">Audit.<span className="absolute bottom-1 left-0 w-full h-[6px] bg-[#C4ED5F] -z-10"></span></span>
              </h1>
            </div>

            <div className="lg:col-span-4 p-10 flex flex-col justify-end bg-black text-white relative overflow-hidden">
              <span className="absolute top-8 right-8 text-[6rem] font-black text-white/5 leading-none select-none">∑</span>
              <SearchCheck className="w-8 h-8 text-[#C4ED5F] mb-6 relative z-10" strokeWidth={1.5} />
        ...
        <div className="mb-16">
          <div className="border-l-4 border-black pl-8 py-2 mb-8">
            <h2 className="text-2xl font-black mb-4">The "Store Now, Decrypt Later" Threat</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-16">
          ...
          <div className="border border-gray-200 p-8 bg-gray-50 hover:bg-white transition-colors shadow-sm">
            <div className="font-mono text-[10px] text-gray-400 font-bold mb-4">PHASE 01</div>
          ...
          <div className="border border-gray-200 p-8 bg-gray-50 hover:bg-white transition-colors shadow-sm">
            <div className="font-mono text-[10px] text-gray-400 font-bold mb-4">PHASE 02</div>
          ...
          <div className="border border-gray-200 p-8 bg-gray-50 hover:bg-white transition-colors shadow-sm">
            <div className="font-mono text-[10px] text-gray-400 font-bold mb-4">PHASE 03</div>
          ...
          <div className="border border-gray-200 p-8 bg-[#C4ED5F] transition-colors shadow-sm">
            <div className="font-mono text-[10px] text-black/60 font-bold mb-4">PHASE 04</div>
        ...
        {/* Deliverables */}
        <div className="border border-gray-200 shadow-sm bg-white overflow-hidden mb-12 flex flex-col md:flex-row">
          <div className="p-10 md:w-1/3 border-b md:border-b-0 md:border-r border-gray-200 bg-gray-50">
            <FileText className="w-8 h-8 text-black mb-4" />
            <h3 className="text-xl font-black mb-2">Deliverables</h3>
            <p className="text-sm text-gray-600">What you receive upon audit completion.</p>
          </div>
          <div className="p-10 md:w-2/3">
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                <CheckCircle2 className="w-5 h-5 text-[#C4ED5F] mt-0.5 shrink-0" />
                <div>
                  <h4 className="font-bold text-sm">Machine-Readable CBOM</h4>
                  <p className="text-sm text-gray-600">CycloneDX formatted JSON/XML file for automated compliance tracking.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <CheckCircle2 className="w-5 h-5 text-[#C4ED5F] mt-0.5 shrink-0" />
                <div>
                  ...
                  <p className="text-sm text-gray-600">A prioritized list of vulnerable systems based on data persistence and exposure.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <CheckCircle2 className="w-5 h-5 text-[#C4ED5F] mt-0.5 shrink-0" />
                <div>
                  <h4 className="font-bold text-sm">Remediation Architecture</h4>
                  <p className="text-sm text-gray-600">Customized technical blueprints for upgrading TLS endpoints, VPNs, and code signing pipelines.</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        {/* CTA */}
        <div className="border border-gray-200 shadow-sm bg-gray-900 flex items-center justify-between p-10 text-white">
          <div>
            <h3 className="font-bold mb-2">Ready to initiate an audit?</h3>
            <p className="text-sm text-gray-400">Avoid the regulatory rush. Connect with our protocol engineering team.</p>
          </div>
